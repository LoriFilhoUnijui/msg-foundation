...
class MSGApplication
{
  ...
  private static float estimatedFundsForMonth;                   // monthly funds available
...
//getter-setters for estimatedFundsForMonth
 public static float getEstimatedFundsForMonth () { return estimatedFundsForMonth; }
  ...
  public static void setEstimatedFundsForMonth(float e)
  //
  //  display report for each change of estimate
  //
  {

    estimatedFundsForMonth = e;
    EstimatedFundsReport.printReport();
